...
export function meta() {
  return [
    { title: "Alimenter mon épargne - LA FINA" },
    { name: "description", content: "Approvisionnez votre compte d'épargne agricole" },
  ];
}

export default function SavingsDepositScreen() {
  ...
  const handleContinue = () => {
    if (method === "momo") {
      ...
      navigate("/savings-confirm-deposit");
    }
  };
